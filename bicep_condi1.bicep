...
@description('The name of the environment. This must be a Development or Produtction.')
@allowed([
  'Development'
  'Production'
])
...
param auditStorageAcoountSkuName string = 'Standard_LRS'
...
resource auditStorageAccount 'Microsoft.Storage/storageAccounts@2022-09-01' = if (auditingEnabled) {
  ...
  location: location
  sku: {
    name: auditStorageAcoountSkuName
  }
  kind: 'StorageV2'
}
